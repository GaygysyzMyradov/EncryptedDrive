...
urlpatterns = [
    ...
    path('delete/file/<slug:slug>/', views.FileDeleteView.as_view(), name='file_delete_view'),
    path('folder/delete/<slug:slug>/', views.FolderDeleteView.as_view(), name='folder_delete_view'),
]